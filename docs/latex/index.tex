...
TODO\hypertarget{index_autotoc_md4}{}\doxysection{Documentation}\label{index_autotoc_md4}
The \mbox{[}docs\mbox{]}(docs) folder contains the documentation of this project. Simply open the \href{docs/html/index.html}{\texttt{ index}} and navigate through the docs.\hypertarget{index_autotoc_md5}{}\doxysection{Code Profiling}\label{index_autotoc_md5}
...
La\+CAM$\ast$ variants are available in \href{https://github.com/Kei18/lacam2/tags}{\texttt{ tags}}.\hypertarget{index_autotoc_md7}{}\doxysection{Licence}\label{index_autotoc_md7}
