...
Example with 200 agents in random-\/32-\/32-\/20.\+map\hypertarget{index_autotoc_md4}{}\doxysubsection{Data visualization}\label{index_autotoc_md4}
...
Screenshot of the dashboard.\hypertarget{index_autotoc_md5}{}\doxysubsection{Documentation}\label{index_autotoc_md5}
...
Alternatively, you can navigate to {\ttfamily docs/html} and open the \href{docs/html/index.html}{\texttt{ index}} file. This will open the html page in the browser and you can scroll through the documentation.\hypertarget{index_autotoc_md6}{}\doxysubsection{Code Profiling}\label{index_autotoc_md6}
...
To stop profiling, clean build the project again using the instructions in the \textquotesingle{}Building\textquotesingle{} section.\hypertarget{index_autotoc_md7}{}\doxysubsection{Notes}\label{index_autotoc_md7}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md8}{}\doxysubsection{Licence}\label{index_autotoc_md8}
